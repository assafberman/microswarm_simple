...
# Simulation dimensions are mm and second
sim = Simulation(length_x=3600, length_y=36, resolution=(1500, 50), dt=0.1, total_time=10)
swarm = Swarm(num_x=5, num_y=5, member_radius=0.05)
